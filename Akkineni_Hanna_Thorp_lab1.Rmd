...
```
From this chart, we can again take away a sense that those countries which had higher violations prior to the regulations were also likely to have relatively higher violations after the regulation, even after controlling for the conflating impacts by normalizing violations by the most appropriate proxy for the mission size-type variables. 

Now we turn to understanding how other variables in our data set might help explain the differences in violations per car
