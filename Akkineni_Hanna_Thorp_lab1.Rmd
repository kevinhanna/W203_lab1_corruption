...
```{r}
par(mfrow = c(1, 2))
hist(correlation_matrix_input$trade/10**9, col="blue") # BILLIONS
boxplot(correlation_matrix_input$trade/10**9, col = "blue")
```
TODO:
...
### Violations/Total Cars (w/ and w/o log())
```{r}
par(mfrow = c(1, 2))
hist(correlation_matrix_input$violations_weighted.cars_total.pre, col="blue") 
hist(correlation_matrix_input$violations_weighted.cars_total.pos, col="blue") 

par(mfrow = c(1, 2))
hist(correlation_matrix_input$violations_weighted.cars_total.pre.log, col="blue") 
hist(correlation_matrix_input$violations_weighted.cars_total.pos.log, col="blue") 
...
## Why We Ignored the Relationship Between Mean Violations and Percentage of Country Who Identify as Muslim
