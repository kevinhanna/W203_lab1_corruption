...
We start our exploratory analysis with a high level look at all our variables. 
...
* Why violations, corruption, total_cars, aid chosen for more analysis.
...
```{r}
par(mfrow = c(1, 2))
hist(correlation_matrix_input$corruption, col="blue")
boxplot(correlation_matrix_input$corruption, col = "blue")
```
...
```{r}
par(mfrow = c(1, 3))
hist(correlation_matrix_input$cars_total, col="blue")
boxplot(correlation_matrix_input$cars_total, col = "blue")
boxplot(correlation_matrix_input$cars_total/correlation_matrix_input$staff, col = "blue")
