...
## Research Question
Prior to 2002 there were no measures New York City (NYC) was able to take to enforce payment of parking violations from UN officials how have diplomatic emmunity. Therefore, payment was largely a function cultural norms.  In 2002 NYC parking enforcement acquired the right to confiscate license plates from veicles belonging to US diplomats if they had accumulated unpaid parking violations making payment an function of both cultral norms and legal enforcment.  
 
 In our exploratory data analysis, we will describe how cultural norms affect the payment of parking violations by researching the the number of violations diplomats had accumulated both before and after the enforcement changes using the corruption index of country they of the embassy they are accociated with.  

## Description of Dataset

Our data set has a total of 364 observations, there are two observation for each country, where only the number of violations and value of the fines changes, one before NYC gained the ability to enforce non-payment, and another after. Additionally, there are 66 observations that we have removed (reasoning and expected effect described below) leaving us with 149 observations with the following variables.
...
kable(variable_description, caption = "Variables Used") %>%
...
#Alex notes to be explained above
